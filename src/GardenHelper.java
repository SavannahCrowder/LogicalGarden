public class GardenHelper {
    ...
    /*
       I will need to create a method that will check if the row parameter is a valid row number. I will also need to add
       a new row and stores the new object in GardenRow one, two, or three.
     */
    ...
    /*
        In the method addPlant its takes the parameters string plantName and integer row. This code calls the method
        canPlant this checks if the plant can be planted in the row provided. If canPlant returns true the program will
        print the plants name in upper case followed by added to row and the row it is added to.If it returns true the
        searchRow method will be used which will find a row where the plant can be planted.
        If the method returns false the program will print plants name in upper case and was unable to be planted.
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Testing canPlant(carrot, 1):");
        System.out.println("EXPECTING: false");
